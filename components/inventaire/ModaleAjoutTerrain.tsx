...
export default function ModaleAjoutTerrain({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 bg-black/20 backdrop-blur-sm animate-entree overflow-y-auto">
      <div className="relative w-full max-w-[95vw] sm:max-w-4xl max-h-[85vh] bg-white dark:bg-brand-paper rounded-3xl shadow-2xl border border-brand-light-grey dark:border-white/10 flex flex-col overflow-hidden my-auto">
