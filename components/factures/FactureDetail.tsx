        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex bg-brand-light-grey/20 rounded-lg p-1 ml-2">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-bold rounded-md transition ${!formatTicket ? 'bg-brand-black text-white shadow-sm' : 'bg-brand-light-grey/30 text-brand-warm-grey hover:bg-brand-light-grey/50 hover:text-brand-black'}`}
            >
              A4
            </button>
            <button
