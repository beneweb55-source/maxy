    ...
    <div className="space-y-6 animate-entree">
      ...
      {modalOuverte && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/30 backdrop-blur-sm animate-entree">
          <div className="bg-white dark:bg-brand-paper w-full sm:max-w-md max-h-[88vh] sm:max-h-[85vh] flex flex-col overflow-hidden sm:rounded-3xl rounded-t-3xl shadow-2xl border border-brand-light-grey/60 dark:border-white/10">
            <div className="flex items-center justify-between px-5 py-4 border-b border-brand-light-grey/40 dark:border-white/10">
              <h2 className="font-black text-base font-outfit text-brand-black dark:text-white">
                {entiteEditee
              ...
              <button
                ...
                className="h-9 w-9 flex items-center justify-center text-brand-warm-grey hover:text-brand-black dark:hover:text-white rounded-xl hover:bg-brand-light-grey/30 dark:hover:bg-white/5 transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={sauvegarder} className="flex flex-col flex-1 overflow-hidden">
              <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                <div>
                  <label className="block text-[11px] font-bold uppercase tracking-wider text-brand-warm-grey mb-1.5">
                    Nom *
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex-shrink-0 px-5 py-4 border-t border-brand-light-grey/40 dark:border-white/10 bg-brand-paper/50 dark:bg-white/[0.02] flex items-center justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setModalOuverte(false)}
